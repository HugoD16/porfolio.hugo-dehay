      ...
      <div className="section grid md:grid-cols-2 gap-8 items-center">
        <motion.div initial={{opacity:0,y:10}} animate={{opacity:1,y:0}} transition={{duration:.6}}>
          ...
          <p className="mt-6 text-lg text-gray-700">
            ...
            J’aime automatiser les tâches avec PowerShell, administrer Active Directory/GPO et documenter des procédures claires.
          </p>
          <div className="mt-8 flex gap-3">
            <a href="/CV_Hugo_Dehay.pdf" className="px-5 py-3 rounded-xl bg-primary text-white shadow-soft">Télécharger mon CV</a>
