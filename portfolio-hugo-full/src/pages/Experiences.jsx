      ...
      <div className="relative pl-8">
        ...
        <div className="mb-8 relative">
          ...
          <div className="card">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1 text-gray-700">
              <li>Scripts <b>PowerShell</b> pour création/gestion des comptes <b>Active Directory</b>.</li>
              <li>Automatisations <b>Office 365</b> : Outlook, Teams, OneDrive.</li>
              <li>GPO : suppression profils inactifs, redémarrage hebdomadaire postes.</li>
              <li>Migration <b>Windows 10 → 11</b> (clé USB personnalisée).</li>
              <li>Inventaire des postes AD.</li>
              <li>Migration <b>GLPI</b> (MariaDB → MySQL).</li>
              <li>Rédaction de <b>procédures</b> techniques.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-8 relative">
          ...
          <div className="card">
            ...
            <p className="text-gray-700 mt-2">Accueil, service en restauration.</p>
          </div>
        </div>
